class OperatorsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @operator.update(operator_params)
        format.html { redirect_to @operator, notice: 'Operador alterado com sucesso!' }
  ...
  def destroy
    @operator.destroy
    respond_to do |format|
      format.html { redirect_to operators_url, notice: 'Operador excluído com sucesso!' }
  ...
  private
    ...
    def operator_params
      params.require(:operator).permit(:name, :code)
    end
end
